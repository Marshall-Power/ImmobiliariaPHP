  ...
  <div id="welcome" class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-4 houses_div">
                        <div class="btn btn-success offset-lg-1"><p>Comprar</p></div>
                        <div class="btn btn-success"><p>Alquilar</p></div>
                            ...
                            <div class="col-lg-12 offset-lg-1 house_card_main">
                                    <div class="row house_card">
                                        ...
                                        <div class="col-lg-3 pull-lg-1 card_div">
                                                <div class="card">
                                                        <img class="card-img-top" src="https://inmobiliarialowcostalbacete.com/wp-content/uploads/2017/07/inmobiliaria-low-cost-tu-gran-acierto-1.png" alt="Card image cap">
                                                        <div class="card-body">
